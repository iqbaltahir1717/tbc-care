...
class Pasien extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($data['pasien'] as $p) {
            ...
            $data["data"][] = [$p->user_id, $p->user_fullname, $p->user_gender, $p->user_birth, $p->user_bb, $p->user_tb, $p->user_status, $p->user_email, $p->user_no, $p->user_activity, $hs, $bmr,  $data["menu"]];
        }
        // echo "<pre>";
        // print_r($data["data"]);
        // echo "</pre>";
