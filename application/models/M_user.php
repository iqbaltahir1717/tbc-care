...
class M_user extends CI_Model
{
    ...
    public function widget()
    {
        $query  = $this->db->query(" SELECT
            (SELECT count(user_id) FROM tbl_user WHERE user_status = 'Pasien Baru' ) as total_pasien_baru, (SELECT count(user_id) FROM tbl_user WHERE user_status = 'Masa Pengobatan') as total_pasien_proses, (SELECT count(user_id) FROM tbl_user WHERE user_status = 'Selesai') as total_pasien_selesai");
        return $query->result();
    }
}
